...
$c_Lcalculator_Calculator$.prototype.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D = (function(expr, references, set) {
  _loop: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a, references, set) + this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b, references, set))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a$2, references, set) - this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b$2, references, set))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a$3, references, set) * this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b$3, references, set))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a$4, references, set) / this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b$4, references, set))
    } else {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(expr, references, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())))
});
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      if ((disc < 0)) {
        ...
        var array$1 = [((((-$uD(b$2.apply__O())) + $uD($g["Math"]["sqrt"](disc))) / 2) * $uD(a$2.apply__O())), ((((-$uD(b$2.apply__O())) - $uD($g["Math"]["sqrt"](disc))) / 2) * $uD(a$2.apply__O()))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var rest = $uI(remainingCharsCount$1.apply__O());
      return ((rest >= 15) ? "green" : ((rest >= 0) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    return new $c_T2().init___O__O(k, new $c_Lcalculator_Var().init___F0(expr))
  } else {
